...
class LoginController extends Controller
{
    ...
    {
        // mode=register kalau ingin langsung buka card register
        $slug = $request->query('mode') === 'register' ? 'register-page' : 'login-page';
    ...
    public function register_post(Request $request)
    {
        ...
        // Kembali ke halaman login dengan query mode=login
        return redirect('/signin?mode=login');
    }
